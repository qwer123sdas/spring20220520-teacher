...
<body>
		...
		<div class="row justify-content-center">
			<div class="col-12 col-lg-6">
				...
				<div>
					...
					<label for="passwordInput2" class="form-label"> 암호확인 </label>
					<input  class="form-control" id="passwordInput2" type="text" value="" />
					<p id="passwordMessage"></p>

					<label for="emailInput" class="form-label"> 이메일 </label>
					<div class="input-group">
						<input class="form-control" id="emailInput" type="text" value="${member.email }" />
						<button class="btn btn-secondary" id="email-input-button" disabled>이메일중복확인</button>
					</div>
					<p id="emailMessage"></p>

					<label for="nickNameInput" class="form-label"> 닉네임 </label>
					<div class="input-group">
						<input class="form-control" id="nickNameInput" type="text" value="${member.nickName }" />
						<button class="btn btn-secondary" id="nickName-input-button"
							disabled>닉네임중복확인</button>
					</div>
					<p id="nickNameMessage"></p>

					<label for="idInput1" class="form-label"> 가입일시 </label>
					<input class="form-control" type="datetime-local" value="${member.inserted }" readonly />

					<div>
						<button id="submitModifyButton1" data-bs-toggle="modal"
	...
	<div class="modal fade" id="modal2" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel2">수정하기</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<form id="form2" action="${appRoot }/member/modify" method="post">
						...
						<input id="passwordInput4" type="text" name="oldPassword" />
					</form>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
